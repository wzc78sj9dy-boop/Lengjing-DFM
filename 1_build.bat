...
set "COORDINATE_SESSION_LOG=ON"
set "PERFORMANCE_TRACE=OFF"
set "BUILD_RESULT=0"
set "CLEAN_BUILD=0"
set "PAUSE_ON_EXIT=1"
...
if /i "%LENGJING_PERFORMANCE_BUILD%"=="1" set "PERFORMANCE_TRACE=ON"
...
echo [COORDINATE_SESSION_LOG] !COORDINATE_SESSION_LOG!
echo [PERFORMANCE_TRACE] !PERFORMANCE_TRACE!
...
cmake -Wno-deprecated --no-warn-unused-cli -S "%SOURCE_DIR%" -B "%BUILD_DIR%" -G Ninja ^
    ...
    -DLENGJING_ENABLE_COORDINATE_SESSION_LOG=!COORDINATE_SESSION_LOG! ^
    -DLENGJING_ENABLE_PERFORMANCE_TRACE=!PERFORMANCE_TRACE! ^
