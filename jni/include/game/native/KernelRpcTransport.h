...
struct ConfiguredCapabilities {
    bool attachProcessProtocolKnown = false;
    bool processExecutionContextRead = false;
    bool threadScopedExecutionContext = false;
    bool installApgaKey = false;
};
...
public:
    ...
    kernel_rpc_abi::ConfiguredCapabilities Capabilities() const noexcept;
