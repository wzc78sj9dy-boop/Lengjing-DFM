...
bool ImGui::ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags, const float* ref_col)
{
    ...
    const float picker_rounding = ImMin(style.FrameRounding, 6.0f);
    ...
    else if (flags & ImGuiColorEditFlags_PickerHueBar)
    {
        ...
        RenderFrameBorder(picker_pos, picker_pos + ImVec2(sv_picker_size, sv_picker_size), picker_rounding);
        ...
        RenderFrameBorder(ImVec2(bar0_pos_x, picker_pos.y), ImVec2(bar0_pos_x + bars_width, picker_pos.y + sv_picker_size), picker_rounding);
    ...
    if (alpha_bar)
    {
        ...
        RenderFrameBorder(bar1_bb.Min, bar1_bb.Max, picker_rounding);
