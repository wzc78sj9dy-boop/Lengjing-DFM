...
#endif
    if (vkCreateInstance == nullptr || vkDestroyInstance == nullptr ||
        vkEnumeratePhysicalDevices == nullptr ||
        vkGetPhysicalDeviceProperties == nullptr ||
        vkGetPhysicalDeviceQueueFamilyProperties == nullptr ||
        vkCreateDevice == nullptr || vkDestroyDevice == nullptr ||
        vkEnumerateDeviceExtensionProperties == nullptr ||
        vkGetDeviceQueue == nullptr || vkCreateDescriptorPool == nullptr ||
        vkCreateAndroidSurfaceKHR == nullptr ||
        vkGetPhysicalDeviceSurfaceSupportKHR == nullptr ||
        vkAcquireNextImageKHR == nullptr || vkQueuePresentKHR == nullptr) {
        dlclose(libvulkan);
        return 0;
    }

    g_VulkanLibrary = libvulkan;
    return 1;
}
