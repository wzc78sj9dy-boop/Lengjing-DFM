...
void RunAlgorithmPositionPolicyTests() {
    ...
    REQUIRE((!ProcessExecutionContext{1, 0, 0}.IsUsable()));
    REQUIRE((!ProcessExecutionContext{0, 1, 0}.IsUsable()));
    REQUIRE((ProcessExecutionContext{1, 1, 0}.IsUsable()));
    REQUIRE((ProcessExecutionContext{1, 0, 1}.IsUsable()));
}
